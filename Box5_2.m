...
X(10:12,10:12)=40; X(13:15,13:15)=32; 
N=normrnd(0,1.5,[20,20]); X=X+N;
subplot(3,1,1); image(X); colormap(gray); brighten(.5); 
axis([1 20 1 20],'square'); title('Image 1');

% Read in the second image (i.e., Y) and plot
N=normrnd(0,1.5,[20,20]); Y=-X+N+50;
subplot(3,1,2); image(Y); title('Image 2');
axis([1 20 1 20],'square');
...
xlabel('Image 1 Bin Number'); ylabel('Image 2 Bin Number');
